...
plt.legend()
plt.title("Rosenbrock calls for the CG descent")
plt.savefig("ros_conjugate_gradient_calls.png")

plt.figure()
plt.semilogy(recorder.old, label="Old value")
plt.semilogy(np.arange(-1, -1 + len(recorder.new)), recorder.new, label="New value")
plt.legend()
plt.title("Rosenbrock values with a CG descent")
plt.savefig("ros_conjugate_gradient_values.png")
...
plt.title("Rosenbrock positions with a CG descent")
plt.savefig("ros_conjugate_gradient.png")
