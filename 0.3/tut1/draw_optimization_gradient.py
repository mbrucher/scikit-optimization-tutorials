...
plt.legend()
plt.title("Rosenbrock calls for the Gradient descent")
plt.savefig("ros_gradient_calls.png")

plt.figure()
plt.semilogy(recorder.old, label="Old value")
plt.semilogy(np.arange(-1, -1 + len(recorder.new)), recorder.new, label="New value")
plt.legend()
plt.title("Rosenbrock values with the Gradient descent")
plt.savefig("ros_gradient_values.png")
...
plt.title("Rosenbrock positions with the Gradient descent")
plt.savefig("ros_gradient.png")
